Stoplight Scenarios is a powerful (but accessible!) tool that takes the pain out of API testing. It available on [the web](https://next.stoplight.io), and as a [desktop app](https://download-next.stoplight.io).
